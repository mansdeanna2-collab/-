#!/bin/bash
# Post-install script to apply patches and fix Gradle compatibility issues
# Fixes deprecated Gradle features for Gradle 9.0 compatibility
...
if [ -f "$CORDOVA_TEMPLATE_PATH" ]; then
    ...
    echo "✓ Fixed lintOptions deprecation in capacitor-cordova-android-plugins template"
fi
